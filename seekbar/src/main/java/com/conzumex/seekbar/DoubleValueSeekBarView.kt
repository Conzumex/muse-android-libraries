...
open class DoubleValueSeekBarView : View {
    ...
    private fun init(attrs: AttributeSet) {
        ...
        minValuePaint.apply {
            ...
            if(customFontFamily!=0){
                val newTypeface = ResourcesCompat.getFont(context,customFontFamily)
    ...
    private fun parseAttr(attrs: AttributeSet?) {
        val typedArray = context.theme.obtainStyledAttributes(attrs,
            R.styleable.DoubleValueSeekBarView, 0, 0)
        ...
        val fontId = typedArray.getResourceId(R.styleable.DoubleValueSeekBarView_seekFontFamily,0)
