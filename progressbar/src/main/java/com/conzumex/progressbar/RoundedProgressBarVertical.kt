package com.conzumex.progressbar
...
import com.conzumex.progressbar.ProgressTextOverlayVertical.Companion.DEFAULT_FONT_PATH
import com.conzumex.progressbar.ProgressTextOverlayVertical.Companion.DEFAULT_SHOW_TEXT
import com.conzumex.progressbar.ext.setDrawableTint
import com.conzumex.progressbar.utils.calculateAppropriateCornerRadius
...
import kotlinx.android.synthetic.main.layout_rounded_progress_bar_vertical.view.progress_text_overlay_vertical

class RoundedProgressBarVertical @JvmOverloads constructor(
    context: Context,
    ...
    companion object {
        ...
        private const val PROGRESS_BAR_MAX = 120
    ...
    @ColorInt private val defaultProgressDrawableColor = ContextCompat.getColor(context,
        R.color.rpb_default_progress_color
    )
    @ColorInt private val defaultBackgroundDrawableColor = ContextCompat.getColor(context,
    ...
    @ColorInt private val defaultProgressTextColor: Int = ContextCompat.getColor(context,
        R.color.rpb_default_text_color
    )
    @ColorInt private val defaultBackgroundTextColor: Int = ContextCompat.getColor(context,
        R.color.rpb_default_text_color
    )
    ...
    private val progressTextOverlay: ProgressTextOverlayVertical
    ...
    init {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.layout_rounded_progress_bar_vertical, this, false)
        progressBar = view.rounded_progress_bar
        progressTextOverlay = view.progress_text_overlay_vertical
    ...
    private fun initAttributes(attrs: AttributeSet?) {
        ...
        val fontId = rpbAttributes.getResourceId(R.styleable.RoundedProgressBar_rpbFontFamily,0)
        if (fontId != 0) setCustomFontFamily(fontId)
    ...
    private fun createRoundedProgressDrawable(): Drawable {
        ...
        return ScaleDrawable(roundedDrawable, Gravity.BOTTOM, -1f, 1f)
    }
    ...
    /**
     * This method allows you to change the font family for the progress overlay text.
     *
     * @param newFontFamily A resource id to your font family
     */
    fun setCustomFontFamily(newFontFamily: Int) {
        customFontFamily = newFontFamily
        progressTextOverlay.setCustomFontFamily(customFontFamily)
    }
    ...
    public override fun onSaveInstanceState(): Parcelable? {
        ...
        savedState.savedCustomFontFamily = customFontFamily
        return savedState
    }
    ...
    internal class SavedState : BaseSavedState {
        ...
        var savedCustomFontFamily: Int = 0
        ...
        constructor(source: Parcel) : super(source) {
            ...
            savedCustomFontFamily = source.readInt()
        }
        ...
        override fun writeToParcel(out: Parcel, flags: Int) {
            ...
            out.writeInt(savedCustomFontFamily)
        }
