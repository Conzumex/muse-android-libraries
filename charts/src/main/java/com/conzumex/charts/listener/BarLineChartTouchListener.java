package com.conzumex.charts.listener;
...
import com.conzumex.charts.charts.BarLineChartBase;
import com.conzumex.charts.charts.HorizontalBarChart;
...
//                        scaleX=scaleX-zoomOutableValue;
                        if(isZoomingOut) {
                            float zoomOutableValue=h.getZoomOutXValue();
//                            Log.d("CHART"," Zoom Out :: Scalex : "+scaleX+", Zoomable : "+zoomOutableValue+", T.x "+t.x+", mScaleX "+h.getScaleX()+", minScalex "+h.getMinScaleX());
                            scaleX=Math.max(scaleX,zoomOutableValue);
                        }else{
                            float zoomInableValue=h.getZoomInXValue();
//                            Log.d("CHART"," Zoom In :: Scalex : "+scaleX+", Zoomable : "+zoomInableValue+", T.x "+t.x+", mScaleX "+h.getScaleX()+", minScalex "+h.getMinScaleX());
                            scaleX=Math.min(scaleX,zoomInableValue);
                        }
