...
public class RoundedCandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    float[] corners;
    public RoundedCandleStickChartRenderer(CandleDataProvider chart, ChartAnimator animator,
                                           ViewPortHandler viewPortHandler, float[] corners) {
