...
package com.conzumex.charts.utils;
...
public class ViewPortHandler {
    ...
    /**
     * Returns value for how much can be zoomed out in the x-axis
     *
     * @return float
     */
    public float getZoomOutXValue() {
        return mMinScaleX/mScaleX ;
    }
    ...
    /**
     * Returns value for how much can be zoom in on the x-axis
     *
     * @return float
     */
    public float getZoomInXValue() {
        return mMaxScaleX/mScaleX ;
    }
